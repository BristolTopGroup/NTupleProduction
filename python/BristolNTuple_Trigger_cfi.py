...
nTupleTriggerIsoMu18 = nTupleTrigger.clone( Prefix='HLTIsoMu18.', PathOfInterest='HLT_IsoMu18_v', tightenTrigger = True, hltFilter = 'hltL3crIsoL1sMu16L1f0L2f10QL3f18QL3trkIsoFiltered0p09', cut = 'eta > -2.1 && eta < 2.1', minNumber = 1 )
...
nTupleTriggerIsoMu18MC = nTupleTrigger.clone( Prefix='HLTIsoMu18MC.', PathOfInterest='HLT_IsoMu17_eta2p1', tightenTrigger = True, hltFilter = 'hltL3crIsoL1sSingleMu16erL1f0L2f10QL3f17QL3trkIsoFiltered0p09', cut = 'pt > 18', minNumber = 1 )
