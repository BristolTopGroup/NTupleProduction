...
BristolNTuple_BeamSpot::BristolNTuple_BeamSpot(const edm::ParameterSet& iConfig) :
...
produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if(beamSpot.isValid()) {
    ...
    edm::LogError("BristolNTuple_BeamSpotError") << "Error! Can't get the product " << "offlineBeamSpot";
  }
