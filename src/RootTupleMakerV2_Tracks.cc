...
RootTupleMakerV2_Tracks::RootTupleMakerV2_Tracks(const edm::ParameterSet& iConfig) :
...
//          hasValidHitInFirstPixelBarrel->push_back(it->hitPattern().hasValidHitInFirstPixelBarrel());
    ...
    edm::LogError("RootTupleMakerV2_TrackError") << "Error! Can't get the product " << "generalTracks";
  }
