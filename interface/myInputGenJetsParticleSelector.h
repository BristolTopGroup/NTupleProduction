#ifndef __myInputGenJetsParticleSelector__
#define __myInputGenJetsParticleSelector__

/* \class myInputGenJetsParticleSelector
 * 
...
class myInputGenJetsParticleSelector : public edm::EDProducer {
  // collection type
 public:
  typedef std::vector<bool>     ParticleBitmap;
  typedef std::vector<const reco::GenParticle*> ParticleVector;
      
  myInputGenJetsParticleSelector(const edm::ParameterSet & ); 
 ...
 private:
  ...
  myInputGenJetsParticleSelector(){} //should not be used!
