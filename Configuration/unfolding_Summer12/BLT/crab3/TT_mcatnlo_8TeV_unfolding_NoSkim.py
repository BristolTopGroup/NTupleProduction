...
config.JobType.pyCfgParams = ['useData=0', 'dataType=TTJets', 'isTTbarMC=1', 'skim=NoSkim', 'storePDFWeights=0', 'applyType0METcorrection=1', 'applySysShiftCorrection=1', 'isMCatNLO=1']
